...
import 'package:catalogmovie/widget/webview_widget.dart';
import 'package:catalogmovie/widget/youtube_player_widget.dart';
...
class MovieDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      ChangeNotifierProvider(
      create: (_) => sl<MovieGetVideosProvider>()..getVideos(context, id: id),
      ),
      ],
...
class _WidgetAppBar extends SliverAppBar {
  ...
  List<Widget>? get actions => [
    ...
    child:  CircleAvatar(
      ...
      child: IconButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => WebViewWidget(
          title: movie.title, 
          url: movie.homepage,
          ),
          ),
...
class _Content extends StatelessWidget {
  const _Content({super.key, required this.title, required this.body, this.padding = 16.0});
    ...
    builder: (_, provider, __) {
      ...
      if (movie != null)  {
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _Content(title: 'Release Date', body: Row(
              children: [
              const Icon(
